    ...
    <>
      <div className='bg-blue-900 text-white py-10 px-2 lg:p-10 rounded-2xl'>
        ...
        {Object.keys(photo).length > 0 && (
          <div>
            <h1 className='text-center text-yellow-600  my-6 mt-20 sm:my-14 text-3xl md:text-5xl'>Details Page</h1>
            <div className='flex flex-col sm:flex-row mt-1 sm:mt-14 w-full md:w-11/12'>
              ...
              <div className='flex flex-col justify-center mt-10 ml-4 lg:ml-20'>
                <h1 className='text-3xl lg:text-4xl tracking-wider leading-snug font-semibold '>Name: {photo.title} </h1>
                <h1 className='text-3xl lg:text-4xl tracking-wider leading-snug font-semibold '>Description:{photo.description}</h1>
